...
namespace entregaLohane.Controllers
{
    public class ContatoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,email,NumeroTelefone")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,email,NumeroTelefone")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
