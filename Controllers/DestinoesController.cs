...
namespace entregaLohane.Controllers
{
    public class DestinoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Nomedestino,NumeroVoo,dataida,datavolta")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Nomedestino,NumeroVoo,dataida,datavolta")] Destino destino)
        {
            if (id != destino.id)
            {
                return NotFound();
